...
public class Ministat {
    ...
    @SerializedName("data")
    private List<MinistatData> results;

    public Ministat(String respcode, String errors, String message, List<MinistatData> results) {
    ...
    public List<MinistatData>  getResults() {
        return results;
    }

    public void setResults(List<MinistatData> results) {
        this.results = results;
    }
}